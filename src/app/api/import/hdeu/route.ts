 ...
 * sending Member State's HDAB before transmission). This is a staff-initiated
 * UI action (the "Import application" form), not an externally-triggered
 * webhook — `userId` is a query param, not a body field, since the body is
 * the raw external payload verbatim.
 */
